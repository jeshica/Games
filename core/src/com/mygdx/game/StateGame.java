...
public class StateGame extends State {
	...
	private TextureRegion _imgBrick;
	...
	public void load() {
		...
		assetManager.load("data/gemBrick.png", Texture.class);
	...
	public void unload() {
		...
		assetManager.unload("data/gemBrick.png");
	...
	public void assignResources() {
		...
		_imgBrick = new TextureRegion(assetManager.get("data/gemBrick.png", Texture.class));
